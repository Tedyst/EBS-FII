...
class TestAggregationFilter(unittest.TestCase):
    def setUp(self):
        ...
        self.subscription = Subscription(
            ...
            temp_agg=Aggregatable(
                value=20, comparator=Comparator.GREATER, agregate_type=AggregateType.AVG
            ),
        )
    ...
    def test_window_value_sum(self):
        ...
        subscription = Subscription(
            id="sub2",
            temp_agg=Aggregatable(
                value=50, comparator=Comparator.GREATER, agregate_type=AggregateType.SUM
            ),
        )
    ...
    def test_window_value_min(self):
        ...
        subscription = Subscription(
            id="sub3",
            temp_agg=Aggregatable(
                value=5, comparator=Comparator.GREATER, agregate_type=AggregateType.MIN
            ),
        )
    ...
    def test_window_value_max(self):
        ...
        subscription = Subscription(
            id="sub4",
            temp_agg=Aggregatable(
                value=25, comparator=Comparator.GREATER, agregate_type=AggregateType.MAX
            ),
        )
    ...
    def setUp(self):
        ...
        self.subscription_wind = Subscription(
            ...
            wind_agg=Aggregatable(
                value=5, comparator=Comparator.GREATER, agregate_type=AggregateType.MAX
            ),
        )
        ...
        self.subscription_both = Subscription(
            id="both_sub",
            temp_agg=Aggregatable(
                value=15, comparator=Comparator.GREATER, agregate_type=AggregateType.AVG
            ),
            wind_agg=Aggregatable(
                value=10, comparator=Comparator.LESS, agregate_type=AggregateType.MAX
            ),
        )
